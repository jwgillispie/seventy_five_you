...
@router.get("/{firebase_uid}", response_model=Day)
...
@router.put("/{firebase_uid}", response_model=Day)
...
@router.delete("/{firebase_uid}", response_description="Day deleted from the database")
...
@router.get("/{firebase_uid}/{date}", response_model=Day)
...
@router.patch("/{firebase_uid}", response_model=Day)
