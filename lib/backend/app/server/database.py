...
from server.models.second_workout_model import SecondWorkout
...
async def init_db():
    ...
    await init_beanie(database=client.seventy_five_hard, document_models=[User, Reminder, Day, Challenge, Diet, InsideWorkout, OutsideWorkout, SecondWorkout, Water, Alcohol, TenPages])
